        ...
        <div className="bg-gray-50 dark:bg-[#161b22] px-4 py-3 border-b border-gray-200 dark:border-[#30363d] flex flex-col sm:flex-row justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-[#c9d1d9] flex items-center gap-2">
              Refactor: Migrate legacy auth to RBAC module <span className="text-gray-400 font-normal">#42</span>
            </h3>
            <div className="flex items-center gap-2 mt-1 text-sm text-gray-500 dark:text-[#8b949e]">
              ...
              <span><strong>peteraraya</strong> {isEs ? 'quiere hacer merge de' : 'wants to merge'} 1 commit {isEs ? 'en' : 'into'} <code className="bg-gray-200 dark:bg-[#30363d] px-1 rounded">main</code> {isEs ? 'desde' : 'from'} <code className="bg-gray-200 dark:bg-[#30363d] px-1 rounded">feat/rbac-auth</code></span>
            </div>
          </div>
          {!isApproved && (
            <button 
        ...
        <div className="p-4 overflow-x-auto text-sm font-mono leading-relaxed">
          <div className="border border-gray-200 dark:border-[#30363d] rounded-lg overflow-hidden">
            <div className="bg-gray-100 dark:bg-[#21262d] px-4 py-2 border-b border-gray-200 dark:border-[#30363d] flex items-center gap-2 text-gray-600 dark:text-[#8b949e] text-xs">
              <span className="text-red-500">- 4</span> <span className="text-green-500">+ 5</span> src/middleware/auth.ts
            </div>
            <div className="bg-white dark:bg-[#0d1117] text-gray-800 dark:text-[#c9d1d9] whitespace-pre min-w-[600px]">
              <div className="flex bg-red-50 dark:bg-[#ffebe9]/10 hover:bg-red-100 dark:hover:bg-[#ffebe9]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-red-200 dark:border-red-900/30">12</div>
                ...
                <div className="pl-4 text-red-700 dark:text-[#ff7b72]">- <span className="text-gray-500">// Legacy token validation</span></div>
              </div>
              <div className="flex bg-red-50 dark:bg-[#ffebe9]/10 hover:bg-red-100 dark:hover:bg-[#ffebe9]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-red-200 dark:border-red-900/30">13</div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-red-200 dark:border-red-900/30 bg-red-100 dark:bg-[#ffebe9]/20"></div>
                <div className="pl-4 text-red-700 dark:text-[#ff7b72]">- <span className="text-purple-600 dark:text-[#d2a8ff]">if</span> (!req.headers.token || req.headers.token !== <span className="text-green-600 dark:text-[#a5d6ff]">'secret_123'</span>) {'{'}</div>
              </div>
              <div className="flex bg-red-50 dark:bg-[#ffebe9]/10 hover:bg-red-100 dark:hover:bg-[#ffebe9]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-red-200 dark:border-red-900/30">14</div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-red-200 dark:border-red-900/30 bg-red-100 dark:bg-[#ffebe9]/20"></div>
                <div className="pl-4 text-red-700 dark:text-[#ff7b72]">-   <span className="text-purple-600 dark:text-[#d2a8ff]">return</span> res.status(401).send(<span className="text-green-600 dark:text-[#a5d6ff]">'Unauthorized'</span>);</div>
              </div>
              <div className="flex bg-red-50 dark:bg-[#ffebe9]/10 hover:bg-red-100 dark:hover:bg-[#ffebe9]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-red-200 dark:border-red-900/30">15</div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-red-200 dark:border-red-900/30 bg-red-100 dark:bg-[#ffebe9]/20"></div>
                <div className="pl-4 text-red-700 dark:text-[#ff7b72]">- {'}'}</div>
              </div>
              ...
              <div className="flex bg-green-50 dark:bg-[#e6ffed]/10 hover:bg-green-100 dark:hover:bg-[#e6ffed]/20">
                ...
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30">12</div>
                <div className="pl-4 text-green-700 dark:text-[#3fb950]">+ <span className="text-gray-500">// Modern RBAC JWT Validation with Zod schema</span></div>
              </div>
              <div className="flex bg-green-50 dark:bg-[#e6ffed]/10 hover:bg-green-100 dark:hover:bg-[#e6ffed]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30 bg-green-100 dark:bg-[#e6ffed]/20"></div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30">13</div>
                <div className="pl-4 text-green-700 dark:text-[#3fb950]">+ <span className="text-purple-600 dark:text-[#d2a8ff]">try</span> {'{'}</div>
              </div>
              <div className="flex bg-green-50 dark:bg-[#e6ffed]/10 hover:bg-green-100 dark:hover:bg-[#e6ffed]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30 bg-green-100 dark:bg-[#e6ffed]/20"></div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30">14</div>
                <div className="pl-4 text-green-700 dark:text-[#3fb950]">+   <span className="text-blue-600 dark:text-[#79c0ff]">const</span> token = extractBearerToken(req);</div>
              </div>
              <div className="flex bg-green-50 dark:bg-[#e6ffed]/10 hover:bg-green-100 dark:hover:bg-[#e6ffed]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30 bg-green-100 dark:bg-[#e6ffed]/20"></div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30">15</div>
                <div className="pl-4 text-green-700 dark:text-[#3fb950]">+   req.user = <span className="text-purple-600 dark:text-[#d2a8ff]">await</span> rbacService.verifyTokenAndRole(token, requiredRoles);</div>
              </div>
              <div className="flex bg-green-50 dark:bg-[#e6ffed]/10 hover:bg-green-100 dark:hover:bg-[#e6ffed]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30 bg-green-100 dark:bg-[#e6ffed]/20"></div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30">16</div>
                <div className="pl-4 text-green-700 dark:text-[#3fb950]">+ {'} '} <span className="text-purple-600 dark:text-[#d2a8ff]">catch</span> (error) {'{'}</div>
              </div>
              <div className="flex bg-green-50 dark:bg-[#e6ffed]/10 hover:bg-green-100 dark:hover:bg-[#e6ffed]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30 bg-green-100 dark:bg-[#e6ffed]/20"></div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30">17</div>
                <div className="pl-4 text-green-700 dark:text-[#3fb950]">+   <span className="text-purple-600 dark:text-[#d2a8ff]">throw new</span> UnauthorizedException(error.message);</div>
              </div>
              <div className="flex bg-green-50 dark:bg-[#e6ffed]/10 hover:bg-green-100 dark:hover:bg-[#e6ffed]/20">
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30 bg-green-100 dark:bg-[#e6ffed]/20"></div>
                <div className="w-12 text-right pr-2 text-gray-400 dark:text-[#8b949e] select-none border-r border-green-200 dark:border-green-900/30">18</div>
                <div className="pl-4 text-green-700 dark:text-[#3fb950]">+ {'}'}</div>
              </div>
            </div>
          </div>
        </div>
